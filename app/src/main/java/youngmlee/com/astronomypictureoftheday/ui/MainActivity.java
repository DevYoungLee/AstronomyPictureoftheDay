...
public class MainActivity extends AppCompatActivity implements FragmentChangeListener{
    ...
    private void loadInitialData(){
        mSharedViewModel.loadInitialData(new ViewModelCallbacks() {
            ...
            public void onFailure(Throwable throwable) {
                ...
                Toast.makeText(getApplicationContext(), getString(R.string.failed_to_load), Toast.LENGTH_LONG)
                        .show();
    ...
    public void attachFullScreenFragment(String url, ImageView sharedImageView) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .addSharedElement(sharedImageView, getString(R.string.image_shared_element))
                .replace(R.id.fragment_container,

...
public class PictureFullScreenFragment extends Fragment {
    ...
    private void shareImage(Bitmap bitmap){
        ...
        startActivity(Intent.createChooser(shareIntent, getString(R.string.share_via_toast_text)));
    }
    ...
    private void saveBitmapToExternal(Bitmap bitmap){
        Toast.makeText(getContext(), getString(R.string.saving_toast_text), Toast.LENGTH_SHORT).show();
    ...
    private File getPublicPictureStorageDir(){
        ...
        File imagesFolder = new File(rootFile, getString(R.string.app_name));
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL: {
                if(grantResults.length > 0
                    ...
                    Toast.makeText(getContext(), getString(R.string.permission_denied_toast_text), Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
